...
Example Site Item::
    ...
    'name': 'Name', # Site Name
    'connection_ok': '1', # Unsure
    'creation_date': None, # Unsure
    'primary_router': None, # Unsure
    'secondary_router': None # Unsure
    }]
...
Example Workstation (Windows) Item::
    ...
    'last_boot_time': '1733834559', # Unix timestamp for last boot time OR "Not Available" if last boot time cannot be gotten.  May add some filtering for this in the future.
    'dsc_active': '1', # Whether daily safety checks are active
    'atz_dst_date': '0000-03-05:00T01:00:00', # No idea, I think when daylight savings hits for the device?
    'utc_apt': '2024-12-10 12:18:52', # Unsure
    'utc_offset': '0', UTC offset for device (if set)
    'user': 'DESKTOP-123\\steveC', # User currently logged in
    ...
    'os': 'Microsoft Windows 10 Pro', # Operating System
    'os_details': 'Microsoft Windows 10 Pro, 64-bit (build 19045)', # Operating System information/Version
    'Build_date': '8/2018', # Computer 'build' date if available
    'Weight': None, # Device weight (if available)
    'Last_SMART_test': None, 
    'Last_MOT_details': '29/7/20 BIOS, SFC, DISM', 
